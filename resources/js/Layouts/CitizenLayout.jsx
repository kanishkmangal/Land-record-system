        ...
        <div className="bg-surface text-on-surface min-h-screen">
            ...
            <main className="pt-14 pb-20">
                {showMessage && flash.success && (
                    <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mx-4 mt-4 shadow-sm" role="alert">
                        <span className="block sm:inline">{flash.success}</span>
                        <button className="absolute top-0 bottom-0 right-0 px-4 py-3" onClick={() => setShowMessage(false)}>
                            <span className="material-symbols-outlined text-sm">close</span>
                        </button>
                    </div>
                )}
                {showMessage && flash.error && (
                    <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mx-4 mt-4 shadow-sm" role="alert">
